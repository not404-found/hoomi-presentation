...
public class HoomiPaymentsApp {
    private static final Logger logger = LoggerFactory.getLogger(HoomiPaymentsApp.class);

    public static void main( String[] args ) throws UnknownHostException {
        final ConfigurableEnvironment env = SpringApplication.run(HoomiPaymentsApp.class, args).getEnvironment();
