...
public class LiveStreamPlayerAdapter extends RecyclerView.Adapter<LiveStreamPlayerAdapter.RecyclerVideoPlayerHolder> implements CacheManager {
    ...
    public LiveStreamPlayerAdapter(Context context, List<PostDto> postDtos, PressablePlayerSelector selector) {
    ...
    public RecyclerVideoPlayerHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View view = inflater.inflate(R.layout.live_streams_player_item, parent, false);
    ...
    public void onBindViewHolder(@NonNull RecyclerVideoPlayerHolder holder, int position) {
        ...
        System.out.println(postDto.getLivesStreamLink());
        ...
        holder.streamerId = postDto.getUserId();
    }
    ...
    public class RecyclerVideoPlayerHolder extends RecyclerView.ViewHolder implements ToroPlayer {
        ...
        private void openSelectedStreamActivity() {
            ...
            selectedLiveStreamActivity.putExtra("streamerId", streamerId);
