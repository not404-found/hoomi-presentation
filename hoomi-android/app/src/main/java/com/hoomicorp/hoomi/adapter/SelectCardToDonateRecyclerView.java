...
public class SelectCardToDonateRecyclerView extends RecyclerView.Adapter<SelectCardToDonateRecyclerView.PaymentCardRecyclerViewHolder> {
    ...
    public SelectCardToDonateRecyclerView(Context mContext, List<PaymentCardDto> cardDtos, OnItemClickListener<PaymentCardDto> onPaymentCardClickedListener) {
